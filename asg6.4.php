...
<div class="form">
<form name="fSearch" id="fSearch" action="asg6.4.php" method="POST">
...
<a href="feedme.php" style="background-color: grey;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;">Add User</a>
</form>
...
if($key=="")
	...
	$sql="select * FROM tblrequest WHERE uname LIKE '%$key%'OR phonenum LIKE '%$key%';";
...
?>
   ...
   Name: <?php echo $row["uname"]?> <br>
   Phone Number: <?php echo $row["phonenum"]?> <br>
   Email Address: <?php echo $row["eaddress"]?> <br>
   Home Address: <?php echo $row["haddress"]?> <br>
   Date Pick Up: <?php echo $row["datepu"]?> <br>
   Collect time: <?php echo $row["ctime"]?> <br>
   Other Request: <?php echo $row["descr"]?> <br>
   Action:<br><a href="asg6.5.php?id=<?php echo $row["id"]?>" style="background-color: grey;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;">Edit</a> 
   <a href="asg6.6.php?id=<?php echo $row["id"]?>"  style="background-color: grey;color: white;padding: 10px 20px;text-align: center;text-decoration: none;display: inline-block;">Delete</a> <br>
<?php
 }
} else {
 echo "0 results";
