...
<head><title>Edit user food donation</title></head>
<style>
body{
  margin: 0;
  padding: 0;
...
<div class=center>
		...
		name="quantity" maxlength="50" value="<?php echo $quantity?>"><br><br>
		
        <label for="date">Select Date:</label><br>
		<input type="date" name="date" id="date" value="<?php echo $date?>" min="<?php echo date("Y-m-d")?>"><br><br>
		
		<label for="time">Select time:</label><br>
        <input type="time" id="time" name="time" ><?php echo $time?><br><br>
